...
(* Visualiser par Marc Billau, dénommé l'identification des couleurs par IBM & et reconnaissance par HAL *)
(* Incruster dans le logiciel Ardoise par son créateur - auteur - Denis bertin le 24 Avril 2015 *)

{Article premier, comme d'une part il est admis que mon cerveau humain à écrit 21 millions de caractère}
{Article deuxième, comme de toute évidance nous sommes quelque un à le comprendre, ainsi}
